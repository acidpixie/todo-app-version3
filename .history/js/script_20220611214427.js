...
class Task {
    ...
    function addTask(e) {
        ...
        if (userInputTask !== "" && !isEdit) {
            ...
            <span class="list-input" id="list-input" contenteditable="false">${newTask.taskname}</span>
   ...
   //     isEdit = true;
    ...
    function editTask() {
        let editField = $('#list-input').attr('contenteditable');
        if (editField == 'false') {
            $('#list-input').attr('contenteditable', 'true');

        } else {

            $('#list-input').attr('contenteditable', 'false');
        }
